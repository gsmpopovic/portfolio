            ...
            <div class='split-right'>
               <div class='cc'>
                  ...
                  <h3>
                     ...
                     <a href="" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/georgesmpopovic/15min'});return false;">Schedule time with me</a> 
                  </h3>
                  <!-- Calendly link widget end -->
               </div>
               <div class='cc'>
                  <h2> Check out my writing, </h2>
                  <a href='https://medium.com/@gpopovic' target="_blank">
                     <h3>
                     Medium
                     <h3>
                  </a>
